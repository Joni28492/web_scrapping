...
"""
Verticalidad y horizontalidad a 2 niveles
https://www.tripadvisor.com/Hotels-g303845-Guayaquil_Guayas_Province-Hotels.html

paginacion a traves de la lista de hoteles
entramos verticalmente a cada uno de ellos
y dentro de estos vamos a ir a los reviews
que tienen paginacion, obtener la info de cada uno de los usuarios que escribe una review
"""
    ...
    rules = (
        ...
        Rule(
            LinkExtractor(  # DETALLE DE HOTELES (VERTICALIDAD DE PRIMER NIVEL)
                ...
                restrict_xpaths=['//div[@class="prw_rup prw_meta_hsx_listing_name listing-title"]']
